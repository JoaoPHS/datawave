...
DW_WILDFLY_VERSION="26.1.3"
# DW_WILDFLY_DIST_URI should, if possible, be using https. There are potential security risks by using http.
DW_WILDFLY_DIST_URI="${DW_WILDFLY_DIST_URI:-https://github.com/wildfly/wildfly/releases/download/${DW_WILDFLY_VERSION}.Final/wildfly-${DW_WILDFLY_VERSION}.Final.tar.gz}"
# The sha1 checksum for the tarball. Value should be the hash value only and does not include the file name. Cannot be left blank.
DW_WILDFLY_DIST_SHA1_CHECKSUM="${DW_WILDFLY_DIST_SHA1_CHECKSUM:-b9f52ba41df890e09bb141d72947d2510caf758c}"
